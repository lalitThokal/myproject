...
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LOCATION 's3://emr-mybucket-lalit/orders';
...
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LOCATION 's3://emr-mybucket-lalit/order_items';
...
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LOCATION 's3://emr-mybucket-lalit/products';


CREATE TABLE daily_product_revenue ( order_date TIMESTAMP, product_name STRING,
revenue FLOAT
) ROW FORMAT DELIMITED FIELDS TERMINATED BY ',' LOCATION 's3://emr-mybucket-lalit/daily_product_revenue';
